...
function searchByID() {
    ...
    fetch('http://localhost:8082/customers/' + id)
        .then(response => response.json())
        .then(data => {
...
function insertCustomer() {
    ...
    fetch('http://localhost:8082/customers/insert?l=' + idString)
...
function updateCustomer() {
    ...
    fetch('http://localhost:8082/customers/update/'+ customerId +'?l=' + dataString)
        .then(response => response.text())
        .then(data => {
            console.log('Response:', data);
            // Handle the response from the backend
...
function deleteById() {
    ...
    fetch('http://localhost:8082/customers/delete/' + id)
        .then(response => response.json())
        .then(data => {
            console.log('Response:', data);
            // Handle the response from the backend
...
function PutCustomer() {
    ...
    fetch(`http://localhost:8082/customers/${customerId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
